...
countries=np.sort(np.array(pd.read_excel(delineation_and_parameter_path+"user_parameters.xlsx",sheet_name="countries")["country_code"]))
...
show(np.where(weight_raster_allyears[1]>=0,1,0))
# %%
uaa_calculated_allyears["country"].value_counts()
# %%
#save uaa_calculated,weight_raster,nuts_indices_relevant and uaa_raster_relevant
uaa_calculated_allyears.to_csv(main_path_data_external+"Intermediary_Data/uaa_calculated_allyears.csv")
# %%
transform_template=rio.open(result_dir+"multi_band_raster/nuts_raster_2003.tif")
if weight_raster_allyears.shape[1:]==transform_template.shape:
    transform=transform_template.transform
#%%
with rio.open(main_path_data_external+"Intermediary_Data/cellweight_raster_allyears.tif", 'w',
...
#%%
with rio.open(main_path_data_external+"Intermediary_Data/nuts_indices_relevant_allyears.tif", 'w',
...
# %%
with rio.open(main_path_data_external+"Intermediary_Data/uaa_raster_allyears.tif", 'w',
...
# %%
nuts_indices_relevant_allyears.max()
# %%
uaa_raster_relevant_allyears
# %%
